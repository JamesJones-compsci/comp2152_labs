...
# monster_power_keys = random.choice(["Fire Magic", "Freeze Time", "Super Hearing"])
...
# if m_combat_strength > 6:  -- Replaced this code with the code above
#    m_combat_strength = 6
...
print("You found even more loot!")
input("Roll the dice for your second item (Press enter)")
loot_item2_idx = random.choice(list(range(len(loot_options))))
...
print("You see the monster in the distance. You can use the first loot item:")
use_item = belt.pop(0)
