...
from old_labs.lab5 import functions_lab05
...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    # Question 5: Roll to see who strikes first
    # Roll to see who strikes first
    attack_roll = random.randint(1, 6)  # Generates a number between 1 and 6
    print(f"\nThe dice rolls... {attack_roll}!")
    ...
    while m_health_points > 0 and health_points > 0:
        ...
        if attack_roll in [1, 3, 5]:  # Hero attacks first
            ...
            if m_health_points == 0:
                num_stars = 3
                break  # Exit loop if monster dies
            ...
            if health_points == 0:
                num_stars = 1
                break  # Exit loop if hero dies
            else:
                num_stars = 2

        else:  # attack_roll is 2, 4, or 6 → Monster attacks first
            ...
            input("You counterattack! (Press Enter)")
            m_health_points = functions_lab05.hero_attacks(combat_strength, m_health_points)
